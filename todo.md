...
1. Tool to generate and visualize call graphs and trace application flows. ****
2. Tool to generate **vertical** sequence diagrams.
...
1. How do I improve LLM planning?
   ...
   3. For now, it may be prudent to develop tools to
