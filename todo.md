...
### Making Thoth into an Omni assistant.
   ...
   - Model picker
   - Automatic research and knowledge synthesis + Continual learning.
   - Deeplink content support.
   - Utility API integration (e.g. with Groot api reverse engineering).
...
## Devops
   - GH actions for building and deploying the app.